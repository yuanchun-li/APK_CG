...
//        Options.v().set_polyglot(true);
        ...
        // loadNecessaryClasses has finished loadClassAndSupport & setApplicationClass
        Scene.v().loadNecessaryClasses();
        //loadNecessaryClassesWithoutLib();
...
*/
        ...
        for (SootClass cls : applicationClasses) {
            for (SootMethod mth: cls.getMethods()){
                Iterator<Edge> edgeItr = applicationCallGraph.edgesOutOf(mth);
